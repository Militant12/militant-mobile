...
class LanguageService extends ValueNotifier<Locale> {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'fr': {
      ...
      'recovery_codes_message': 'Veuillez enregistrer ces codes dans un endroit sûr. Ils vous permettront d\'accéder à votre compte si vous perdez votre application d\'authentification.',
      ...
      '2fa_enabled_message': 'Votre compte est protégé par une double authentification.',
      '2fa_description': 'L\'authentification à deux facteurs ajoute une couche de sécurité supplémentaire en exigeant un code de validation lors de la connexion.',
      ...
      'join_private_group_message': 'Ce groupe est privé. Une demande d\'adhésion sera envoyée aux administrateurs.',
    ...
    'en': {
      ...
      'recovery_codes_message': 'Please save these codes in a safe place. They will allow you to access your account if you lose your authentication app.',
      ...
      '2fa_enabled_message': 'Your account is protected by two-factor authentication.',
      '2fa_description': 'Two-factor authentication adds an extra layer of security by requiring a validation code when logging in.',
      ...
      'join_private_group_message': 'This group is private. A join request will be sent to the administrators.',
    ...
    'es': {
      ...
      'recovery_codes_message': 'Por favor guarda estos códigos en un lugar seguro. Te permitirán acceder a tu cuenta si pierdes tu aplicación de autenticación.',
      ...
      '2fa_enabled_message': 'Tu cuenta está protegida por autenticación de dos factores.',
      '2fa_description': 'La autenticación de dos factores añade una capa extra de seguridad al requerir un código de validación al iniciar sesión.',
      ...
      'join_private_group_message': 'Este grupo es privado. Se enviará una solicitud de adhesión a los administradores.',
